...
export class MedicalRecordService {
    ...
    async createMedicalRecord(data: Prisma.MedicalRecordCreateInput): Promise<MedicalRecord> {
        try {
    ...
    async updateOne(args: Prisma.MedicalRecordUpdateArgs): Promise<MedicalRecord> {
        try {
    ...
    async findOne(args: Prisma.MedicalRecordFindUniqueArgs): Promise<MedicalRecord | null> {
        try {
            const { id } = args.where;
    ...
    async deleteOne(args: Prisma.MedicalRecordDeleteArgs): Promise<{ id: string }> {
        try {
